...
class PartnersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => sl<PartnerBloc>()..add(const LoadPartners(false)), // Mặc định load Khách hàng (false)
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            onTap: (index) {
              // index 0: Khách hàng (isSupplier = false)
              // index 1: Trại heo (isSupplier = true)
              context.read<PartnerBloc>().add(LoadPartners(index == 1));
            },
            tabs: const [
              Tab(icon: Icon(Icons.people), text: "KHÁCH HÀNG (LÁI)"),
              Tab(icon: Icon(Icons.warehouse), text: "TRẠI HEO (NCC)"),
            ],
          ),
        ),
            ...
            return Card(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  ...
                  child: Icon(
                    state.isSupplierFilter ? Icons.warehouse : Icons.person,
          ...
          onPressed: () {
            if (_formKey.currentState!.validate()) {
              final newPartner = PartnerEntity(
                ...
                currentDebt: 0, // Mới tạo thì nợ bằng 0
              );
